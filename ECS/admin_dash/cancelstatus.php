...
<form id="form1">
  ...
  <h1 <caption><b>Complaint Cancelled Successfully!!!</b></caption> </h1>
  <tr>
...
<!-- Bootstrap core JavaScript -->
 ...
 <!-- Footer -->
  <footer class="py-5" style="background-color:#99ff99;">
    <div class="container">
      <p class="m-0 text-center text-dark">Copyright &copy; E-Complaint System 2022 by Nikhil Srivastava</p>
    </div>
</body>
